  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const submitData = { 
        ...
        lead_author: formData.lead_author === "" ? null : formData.lead_author
      };
            ...
            <div className="projectAddForm-form-section">
              ...
              <div className="projectAddForm-form-group">
                ...
                <div className="projectAddForm-form-group projectAddForm-full-width">
                  <label className="projectAddForm-label"><FontAwesomeIcon icon={faLink} /> Shared Resources</label>
                  <div className="projectAddForm-resources">
                    {formData.resources?.length > 0 ? formData.resources.map((res, idx) => (
                      <div key={idx} className="projectAddForm-resource-row">
                        <input
                          type="text"
                        ...
                        <input
                          ...
                          className="projectAddForm-input"
                        />
                        <button type="button" className="projectAddForm-delete-button" onClick={() => removeResource(idx)}>
                          Remove
                        </button>
                      </div>
                    )) : (
                      <div className="projectAddForm-empty-state">No shared links yet</div>
                    )}
                    <button type="button" className="projectAddForm-add-link" onClick={addResource}>
